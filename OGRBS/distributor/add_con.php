				...
				<form id="ac_form" method="post" onSubmit="return nc_sub();">
					...
					<div class="form-group row">
						<label for="name" class="col-sm-2 col-form-label">Name</label>
							...
							<div class="col-sm-3">
							  <input type="text" class="form-control" id="mn" name="mn" placeholder="Middle name" maxlength=10>
							</div>
							<div class="col-sm-3">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
						  <input type="text" class="form-control" id="ct" name="ct" value="'.$dct.'" required>
						</div>
